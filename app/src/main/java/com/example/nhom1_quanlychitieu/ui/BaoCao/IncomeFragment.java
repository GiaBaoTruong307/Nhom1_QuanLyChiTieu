...
public class IncomeFragment extends Fragment {
    ...
    private void loadData() {
        ...
        // Get total income
        dataHelper.getTotalIncome(currentMonth, currentYear, new FirebaseDataHelper.OnTotalLoadedListener() {
            @Override
        ...
        dataHelper.getIncomeByCategories(currentMonth, currentYear, new FirebaseDataHelper.OnCategoriesLoadedListener() {
            @Override
    ...
    private void updateCategoryList(List<CategoryData> categoryDataList) {
        ...
        if (categoryDataList.isEmpty()) {
            ...
            emptyText.setText("Không có dữ liệu thu nhập trong tháng này");
