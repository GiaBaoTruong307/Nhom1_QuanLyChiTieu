...
public class IncomeFragment extends Fragment {
   ...
   /* private void setupDonutChart() {
        ...
        entries.add(new PieEntry(40, "OT"));
        entries.add(new PieEntry(47, "Tiền lương chính"));
        entries.add(new PieEntry(23, "Lãi cho vay"));
        entries.add(new PieEntry(20, "Partime"));

        // Create dataset
        PieDataSet dataSet = new PieDataSet(entries, "");
        dataSet.setColors(
                Color.parseColor("#4FC3F7"),  // Blue - OT
                Color.parseColor("#FFA726"),  // Orange - Tiền lương chính
                Color.parseColor("#9575CD"),  // Purple - Lãi cho vay
                Color.parseColor("#EC407A")   // Pink - Partime
        );
