...
public class BaoCaoChiTieuFragment extends Fragment {
    private static final String TAG = "BaoCaoChiTieuFragment";
    ...
    private static final int[] VIBRANT_COLORS = {
            Color.rgb(255, 102, 102), // Đỏ hồng
            Color.rgb(102, 178, 255), // Xanh dương
            Color.rgb(255, 178, 102), // Cam
            Color.rgb(178, 255, 102), // Xanh lá
            Color.rgb(178, 102, 255), // Tím
            Color.rgb(255, 102, 178), // Hồng
            Color.rgb(102, 255, 178), // Ngọc lam
            Color.rgb(192, 192, 75),  // Vàng đậm
            Color.rgb(102, 102, 255), // Xanh tím
            Color.rgb(255, 102, 255)  // Hồng tím
    };
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        try {
            ...
            Toast.makeText(getContext(), "Lỗi khi tạo giao diện chi tiêu: " + e.getMessage(), Toast.LENGTH_LONG).show();
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    animateTextView(0, total, valueExpense, "-");
                                } catch (Exception e) {
                                    Log.e(TAG, "Error updating expense value", e);
                                }
                            }
                        });
                    }
